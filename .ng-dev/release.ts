import {error, red, ReleaseConfig, ReleasePrecheckError} from '@angular/dev-infra-private/ng-dev';
...
export const release: ReleaseConfig = {
  ...
  prereleaseCheck: async (newVersion, builtPackages) => {
    error(newVersion, builtPackages);
    error(red('Invalid peer dependency. Cannot release.'));
